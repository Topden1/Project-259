...
void set_new_password(){
  ...
  while (true){
   ...
   if (user_password == train()){
     user_password = input_keys();
...
void check_password(){
  ...
  while (true){
    ...
    if (input_password > 12);
    print("Your password is too long");
    else if (input_password < 6);
    print("Your password is too short");
  }
  else{
    if(input_password >6 && input_password < 12);
    print("Your password has officially been registered");
  }
}